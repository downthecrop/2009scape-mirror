...
* Intellij IDEA
* Java SE Development Kit Version 1.11/OpenJDK 1.11 (preferred)
...
1. Install <a href="https://www.oracle.com/java/technologies/downloads/#java11">JDK version 1.11</a>
...
1. Install JDK version 1.11 through <a href="https://www.oracle.com/java/technologies/downloads/#java11">Oracle</a> or through <a href="https://openjdk.java.net/install/">command line</a>
    * Debian, Ubuntu, etc.
    ```sh
...
2. Open Intellij
    ...
    * In Intellij go to File -> Project Structure -> Project and verify your Project SDK is set to JDK "1.11"
