...
public enum Consumables {
	...
	ANTIPOISON(new Potion(new int[] {2446, 175, 177, 179}, new PoisonImmunityEffect(143))),
	ANTIPOISON_(new Potion(new int[] {5943, 5945, 5947, 5949}, new PoisonImmunityEffect(863))),
	ANTIPOISON__(new Potion(new int[] {5952, 5954, 5956, 5958}, new PoisonImmunityEffect(2000))),
	SUPER_ANTIP(new Potion(new int[] {2448, 181, 183, 185}, new PoisonImmunityEffect(1000))),
	...
	SANFEW(new Potion(new int[] {10925, 10927, 10929, 10931}, new MultiEffect(new RestoreEffect(8,0.25), new PrayerEffect(8,0.25), new RemoveTimerEffect("poison"), new RemoveStateEffect("disease")))),
	...
	ANTIP_MIX(new BarbarianMix(new int[] {11433, 11435}, new MultiEffect(new PoisonImmunityEffect(143), new HealingEffect(3)))),
