...
class ZaffPlugin : OptionHandler() {
     ...
     * @version 1.0
     */
    class ZaffDialogue : core.game.dialogue.DialoguePlugin {
        /**
         * The quest.
         */
        ...
        override fun handle(interfaceId: Int, buttonId: Int): Boolean {
            when (stage) {
                ...
                1 -> when (buttonId) {
                    1 -> {
                        interpreter.sendDialogues(player, core.game.dialogue.FacialExpression.HALF_GUILTY, "Yes, please.")
                        stage = 10
                    }
                    2 -> {
                        interpreter.sendDialogues(player, core.game.dialogue.FacialExpression.HALF_GUILTY, "No, thank you.")
                        stage = 20
                    }
                    3 -> {
                        if (quest!!.getStage(player) == 60) {
                            ...
                            interpreter.sendDialogues(player, core.game.dialogue.FacialExpression.HALF_GUILTY, "Can I have another ring?")
                            stage = 50
                        }
                    }
                }
                10 -> {
                    if(player.achievementDiaryManager.getDiary(DiaryType.VARROCK).levelRewarded.contains(true)){
                        npcl(core.game.dialogue.FacialExpression.FRIENDLY, "Would you like to hear about my battlestaves?")
                        stage = 1000
                    } else {
                        end()
                        npc.openShop(player)
     ...
     * @version 1.0
     */
    inner class ZaffStaveDialogue : core.game.dialogue.DialoguePlugin {
        /**
        ...
        override fun open(vararg args: Any): Boolean {
            ...
            interpreter.sendDialogues(player, core.game.dialogue.FacialExpression.HALF_GUILTY, "Do you have any battlestaves?")
            stage = 0
            return true
        }
