...
import content.region.desert.alkharid.quest.princealirescue.NedPARDialogue
 ...
 * @author Ceikry
 */
class NedDialogue(player: Player? = null) : core.game.dialogue.DialoguePlugin(player) {
    /**
