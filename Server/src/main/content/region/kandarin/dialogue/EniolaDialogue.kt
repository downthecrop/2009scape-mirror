...
@Initializable
class EniolaDialogue(player: Player? = null) : core.game.dialogue.DialoguePlugin(player) {
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when (stage) {
            ...
            2 -> playerl(core.game.dialogue.FacialExpression.ASKING, "Who are you?")
                .also { stage++ }
            ...
            4 -> showTopics(
                Topic(core.game.dialogue.FacialExpression.HALF_THINKING, "If you work for the bank, what are you doing here?", 10),
                Topic(core.game.dialogue.FacialExpression.NEUTRAL, "I'd like to access my bank account, please.", 30),
                Topic(core.game.dialogue.FacialExpression.NEUTRAL, "I'd like to check my PIN settings.", 31),
                Topic(core.game.dialogue.FacialExpression.NEUTRAL, "I'd like to see my collection box.", 32),
                Topic(core.game.dialogue.FacialExpression.NEUTRAL, "Never mind.", END_DIALOGUE)
            )
            ...
            20 -> showTopics(
                Topic(core.game.dialogue.FacialExpression.NEUTRAL, "Yes, please.", 30),
                Topic(core.game.dialogue.FacialExpression.SUSPICIOUS, "Let me open my account and then I'll give you the runes.", 21),
                Topic(core.game.dialogue.FacialExpression.ANNOYED, "No way! I'm not paying to withdraw my own stuff.", 22)
            )
