    ...
    override fun defineListeners() {
        ...
        on(THORVALD_LADDER, IntType.SCENERY, "climb-down") { player, _ ->
            if (isQuestComplete(player, "Fremennik Trials") || getAttribute(player, "fremtrials:thorvald-vote", false)) {
                ...
                player.dialogueInterpreter?.sendDialogues(NPCs.THORVALD_THE_WARRIOR_1289, core.game.dialogue.FacialExpression.ANGRY,
            ...
            core.game.global.action.ClimbActionHandler.climb(player, Animation(828), Location.create(2671, 10099, 2))
        ...
        on(THORVALD_LADDER_LOWER, IntType.SCENERY, "climb-up") { player, _ ->
            ...
            core.game.global.action.ClimbActionHandler.climb(player, Animation(828), Location.create(2666, 3694, 0))
            return@on true
        }
