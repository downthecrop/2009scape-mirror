...
class Adventurer(val style: CombatStyle): Script() {
    ...
    fun dialogue() {
        ...
        val Leading2Christmas = listOf(
            ...
            "Deck the hallsss",
			"You doin' anything for Christmas, ${real.username}?",
        ...
        val ChristmasEve = listOf(
			...
			"Dont peek at your presents! Its not Christmas yet!",
        ...
        val Christmas = listOf(
			...
			"Merry Christmas!!!",
			"What presents did you get, ${real.username}?",
        ...
        val NewYearsEve = listOf(
			...
			"Man this sucks, I'm working on New Years...",
			"You doin' anything for New Years, ${real.username}?",
			"Ok who's coming to mine to get on the piss?"
        )
        ...
        val Easter = listOf(
			...
			"I ate so much chocolate oh god my stomach",
			"Mmmmmm choccies...",
			"Where did Woah hide the stash of eggs?",
        ...
        when {
            ...
            formatted.contentEquals("2021-10-31") -> {
                if (Random.nextBoolean()) {
                    val chat = Halloween.random()
                    bot.sendChat(chat)
