...
//
    ...
    //                    setInterfaceText(player,LETTERS[player.getAttribute("riddle-letter-one",0)],DOORLOCKINTERFACE,6)
    //                }
    //                else{
    ...
    //                    setInterfaceText(player,LETTERS[player.getAttribute("riddle-letter-two",0)],DOORLOCKINTERFACE,7)
    //                }
    //                else{
    ...
    //                    setInterfaceText(player,LETTERS[player.getAttribute("riddle-letter-three",0)],DOORLOCKINTERFACE,8)
    //                }
    //                else{
    ...
    //                    setInterfaceText(player,LETTERS[player.getAttribute("riddle-letter-four",0)],DOORLOCKINTERFACE,9)
    //                }
    //                else{
...
//
    ...
    //                            player.setAttribute("riddlesolved",true)
