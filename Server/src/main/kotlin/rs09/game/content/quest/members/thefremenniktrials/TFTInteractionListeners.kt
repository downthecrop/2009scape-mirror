...
class TFTInteractionListeners : InteractionListener(){
    ...
    var FREMENNIK_HELMS = intArrayOf(Items.ARCHER_HELM_3749, Items.BERSERKER_HELM_3751, Items.WARRIOR_HELM_3753, Items.FARSEER_HELM_3755, Items.HELM_OF_NEITIZNOT_10828)
