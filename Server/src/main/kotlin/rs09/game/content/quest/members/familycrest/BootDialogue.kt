    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            10 ->when(buttonId){
                ...
                2 -> npc(FacialExpression.OLD_NORMAL,"I'm called Boot, because when I was very young, ",
            ...
            20 -> when (buttonId){
                1 -> npc(FacialExpression.OLD_NORMAL,"High quality gold eh? Hmmm... " ,
                ...
                3 -> npc(FacialExpression.OLD_NORMAL,"I'm called Boot, because when I was very young, ",
                        "I used to sleep, in a large boot.").also{stage = 11}
            }

            21 -> npc(FacialExpression.OLD_NORMAL,"I don't believe it's exactly easy to get to though...").also {
                stage = 1000;
