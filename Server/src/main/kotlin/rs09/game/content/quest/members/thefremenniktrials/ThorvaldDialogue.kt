...
@Initializable
class ThorvaldDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            0 -> npcl(FacialExpression.FRIENDLY, "And greetings to you too. It is good to see new blood entering the Fremennik; we gain our strength by bringing new warriors into the tribe.").also { stage = 1000 }

            //Merchant Trial - First Talk
            10 -> npcl(FacialExpression.ANNOYED, "Know you not who I am outerlander? There are none more brave or powerful than me amongst all the Fremennik!").also { stage++ }
            11 -> npcl(FacialExpression.ANGRY, "However... The role of bodyguard is below me, as a noble warrior. You might as well ask me to babysit the children!").also { stage++ }
            12 -> playerl(FacialExpression.HALF_ASKING, "Is there no way you would do this for me?").also { stage++ }
            13 -> npcl(FacialExpression.NEUTRAL, "There is but one way outerlander. Since I was steeled in battle, I have dreamt of earning my place at the Champions Table in the Long Hall.").also { stage++ }
            14 -> npcl(FacialExpression.NEUTRAL, "It is a tradition amongst us that the bravest and strongest are honoured with a table of champions to drink and feast all that they can in our Long Hall.").also { stage++ }
            15 -> npcl(FacialExpression.NEUTRAL, "Unfortunately, there are only a fixed number of places available at the table, and these places were all filled many moons ago by others.").also { stage++ }
            16 -> npcl(FacialExpression.NEUTRAL, "Although my worthiness is undeniable, the only way I may take my place is if one of those already there die, or give up their place to me voluntarily.").also { stage++ }
            17 -> playerl(FacialExpression.NEUTRAL, "So you want me to go kill one of them off for you? Make it look like an accident?").also { stage++ }
            18 -> npcl(FacialExpression.EXTREMELY_SHOCKED, "WHAT? No, no, not at all! I am shocked you would suggest such a thing!").also { stage++ }
            19 -> npcl(FacialExpression.NEUTRAL, "If you can persuade one of the Revellers to give up their Champions' Token to you so that I might take their place, you may have my contract as a bodyguard.").also { stage++ }
            20 -> playerl(FacialExpression.NEUTRAL, "Okay, I'll see what I can do.").also {
                player!!.setAttribute("/save:fremtrials:merchant-thorvaldstarted",true)
                stage = 1000
            }

            //Merchant Trial - Doesn't Have Item
            30 -> npcl(FacialExpression.NEUTRAL, "You will need to persuade one of the revellers in the Long Hall to give up their token, and their place, in deference to my own worthiness somehow.").also { stage = 1000 }

            //Merchant Trial - Has Item
            40 -> npcl(FacialExpression.ANNOYED, "Oh you would, would you outerlander? I have already told you, I will not demean myself with such a baby sitting job until I can sit in the Longhall with pride.").also { stage++ }
            41-> playerl(FacialExpression.NEUTRAL, "It's a good thing I have the Champions' Token right here then, isn't it?").also { stage++ }
            42 -> npcl(FacialExpression.NEUTRAL, "Ah... well this is a different matter. With that token I can claim my rightful place as a champion in the Long hall!").also { stage++ }
            43 -> npcl(FacialExpression.NEUTRAL, "Here outerlander, I can suffer the indignity of playing babysitter if it means that I can then revel with my warrior equals in the Long Hall afterwards!").also {
                if (player!!.inventory.remove(Item(Items.CHAMPIONS_TOKEN_3706)) && player!!.inventory.add(Item(Items.WARRIORS_CONTRACT_3710))) {
                    player!!.setAttribute("/save:fremtrials:merchant-thorvaldcompleted",true)
                    player!!.removeAttribute("fremtrials:merchant-thorvaldstarted")
                    stage++
                }
            }
            44 -> npcl(FacialExpression.NEUTRAL, "Here outerlander, take this contract; I will fulfill it to my utmost.").also { stage = 1000 }

            //Merchant Trial - Given Item
            50 -> npcl(FacialExpression.NEUTRAL, "You misunderstand, outerlander. Normally I will only battle for a noble cause, but have never been recognised as a true champion here.").also { stage++ }
            51-> npcl(FacialExpression.NEUTRAL, "With this Champion's token, I can stand alongside my warrior brethren in the Long Hall, and revel in the glories of past victories together!").also { stage = 1000 }
            ...
            74 -> when(buttonId){
                1 -> playerl(FacialExpression.EVIL_LAUGH, "Am I prepared? I'll show you what combat's all about, you big sissy barbarian type guy!").also { player.setAttribute("/save:fremtrials:warrior-accepted",true); stage = 80 }
                ...
                87 -> npcl(FacialExpression.NEUTRAL, "If you need to place your equipment into your bank account, I recommend that you speak to the seer, who knows a spell that will do that for you.").also { stage = 1000 }

                //No thanks
                90 -> npcl(FacialExpression.NEUTRAL, "Hmm, not so brave after all, outerlander? Perhaps it is for the best. I doubt you have what it takes to pass my challenge.").also { stage = 1000 }
            ...
            100 -> when(buttonId){
                ...
                110 -> npcl(FacialExpression.NEUTRAL, "I will not offer my vote to anybody whose bravery in combat I do not trust completely. You must go down that ladder and fight your foe to the death.").also { stage = 1000 }
                ...
                136 -> npcl(FacialExpression.NEUTRAL, "our town, while our warriors are out on a raiding party, Koschei will be able to hold off ANY invader long enough for us to make our return.").also { stage = 1000}
                ...
                143 -> npcl(FacialExpression.NEUTRAL, "If you want my vote, you must pass my trial. It is as simple as that.").also { stage = 1000 }
            ...
            154 -> npcl(FacialExpression.NEUTRAL, "I would be honoured to represent you to the council as worthy of being a Fremennik after watching that superb battle!").also { stage = 1000 }

            //Warrior Trial Completed
            160 -> npcl(FacialExpression.NEUTRAL, "Absolutely! I watched the entire battle, and was extremely impressed with your bravery in combat!").also { stage = 1000 }
