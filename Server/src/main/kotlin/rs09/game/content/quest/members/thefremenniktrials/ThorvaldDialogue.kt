...
class ThorvaldDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            ...
            211 -> npcl(FacialExpression.HAPPY,"You will need to persuade one of the revellers in the Long Hall to give up their token, and their place, in deference to my own worthiness somehow.").also { stage = 1000 }

            214 -> npcl(FacialExpression.ANNOYED,"I'm afraid not, outerlander.").also { stage = 1000 }
            ...
            219 -> npcl(FacialExpression.HAPPY,"Here outerlander, take this contract; I will fulfill it to my utmost.").also { stage = 1000 }
