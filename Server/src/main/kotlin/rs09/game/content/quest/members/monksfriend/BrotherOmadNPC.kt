...
class BrotherOmadListener : InteractionListener() {
    override fun defineListeners() {
        on(NPCs.BROTHER_OMAD_279, NPC, "talk-to"){ player, node ->
