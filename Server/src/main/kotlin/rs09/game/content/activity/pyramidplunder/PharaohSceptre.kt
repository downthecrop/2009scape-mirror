        ...
        override fun handle(componentID: Int, buttonID: Int) {
            ...
            when (stage) {
                ...
                1 -> {
                    ...
                    {
                        player!!.inventory.remove(Item(Items.PHARAOHS_SCEPTRE_9044))
                    ...
                    {
                        player!!.inventory.remove(Item(Items.PHARAOHS_SCEPTRE_9046))
                    ...
                    {
                        player!!.inventory.remove(Item(Items.PHARAOHS_SCEPTRE_9048))
