...
class LecherousLeeDialogue(player: Player? = null) : DialoguePlugin(player){
    ...
    override fun open(vararg args: Any?): Boolean {
        npc = args[0] as NPC
        playerl(FacialExpression.FRIENDLY, "Hello.").also { stage = conversations.random() }
        return true
    }

    override fun handle(interfaceId: Int, buttonId: Int): Boolean {
        when(stage){
            0 -> playerl(FacialExpression.FRIENDLY, "So how's life as a pirate?").also { stage++ }
            ...
            2 -> playerl(FacialExpression.FRIENDLY,"I'm a freelance troubleshooter.").also { stage++ }
            3 -> npcl(FacialExpression.FRIENDLY, "What does that entail then?").also { stage++ }
            ...
            5 -> playerl(FacialExpression.FRIENDLY,"I collect stuff.").also { stage++ }
            6 -> npcl(FacialExpression.FRIENDLY, "So how's that life?").also { stage++ }
            7 -> playerl(FacialExpression.FRIENDLY,"Can't complain, can't complain...").also { stage++ }
            8 -> npcl(FacialExpression.FRIENDLY, "Well, there you go.").also { stage = 99 }

            10 -> playerl(FacialExpression.FRIENDLY, "Aren't you a little short for a pirate?").also { stage++ }
            11 -> npcl(FacialExpression.LAUGH, "My mother was a gnome. Apparently it was a very painful birth.").also { stage++ }
            12 -> playerl(FacialExpression.FRIENDLY,"More info than I wanted, thanks!").also { stage = 99 }
            ...
            14 -> playerl(FacialExpression.FRIENDLY,"I'm not a stowaway! I was invited aboard!").also { stage++ }
            16 -> npcl(FacialExpression.FRIENDLY, "Yeah, whatever guy, it doesn't really matter who you are I'll get in trouble!").also { stage = 99 }
            ...
            27 -> playerl(FacialExpression.FRIENDLY, "Brrrr! Its cold up here!").also { stage++ }
            ...
            29 -> playerl(FacialExpression.FRIENDLY,"REALLY?").also { stage++ }
            ...
            31 -> npcl(FacialExpression.LAUGH, "Hello to you too.").also { stage++ }
            ...
            35 -> playerl(FacialExpression.FRIENDLY,"Oh. Okay. Sorry.").also { stage = 99}


            36 -> npc(FacialExpression.LAUGH, "ARGH!", "SOUND THE ALARM!", "STOWAWAY ON BOARD!", "STOWAWAY ON BOARD!").also { stage++ }
            37 -> playerl(FacialExpression.FRIENDLY,"No! I'm not a stowaway! Honest! I was invited here!").also { stage++ }
            38 -> npcl(FacialExpression.FRIENDLY, "Oh, sorry, my mistake then.").also { stage++ }
            39 -> npcl(FacialExpression.FRIENDLY, "You must admit you do look a lot like a stowaway though.").also { stage++ }
            40 -> playerl(FacialExpression.FRIENDLY,"Why, what do they usually look like?").also { stage++ }
            41 -> npcl(FacialExpression.FRIENDLY, "Erm... I've never actually met one...").also { stage++ }
            42 -> playerl(FacialExpression.FRIENDLY,"Okay then...").also { stage = 99 }

            43 -> npcl(FacialExpression.LAUGH, "Hello.").also { stage++ }
            44 -> playerl(FacialExpression.FRIENDLY,"So... You're a pirate, huh?").also { stage++ }
            45 -> npcl(FacialExpression.FRIENDLY, "It's what it says on my pay-packet at the end of the month.").also { stage++ }
            46 -> playerl(FacialExpression.FRIENDLY,"How's that working out for you?").also { stage++ }
            ...
            48 -> playerl(FacialExpression.FRIENDLY,"You mean you have insurance?").also { stage++ }
            ...
            51 -> playerl(FacialExpression.FRIENDLY,"I can imagine.").also { stage = 99 }

            52 -> npcl(FacialExpression.LAUGH, "Hello there. So what brings you aboard the Lady Zay?").also { stage++ }
            ...
            56 -> npcl(FacialExpression.FRIENDLY, "That she is lad, that she is.").also { stage = 99 }
