...
public enum SummoningPouch {
	 ...
	 * @param peaceful Determines whether the familiar is peaceful and should attack.
	 * @param items The items required to create this pouch.
	 */
	private SummoningPouch(int slot, int pouchId, int levelRequired, double createExperience, int npcId, double summonExperience, int summonCost, boolean peaceful, Item... items) {
		this.slot = slot;
	...
	private SummoningPouch(int slot, boolean abyssal, int pouchId, int levelRequired, double createExperience, int npcId, double summonExperience, int summonCost, boolean peaceful, Item... items) {
		this(slot, pouchId, levelRequired, createExperience, npcId, summonExperience, summonCost, peaceful, items);
	...
	/**
	 * @return Whether the familiar is peaceful
	 */
