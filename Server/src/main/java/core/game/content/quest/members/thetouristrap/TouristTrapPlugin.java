...
import core.game.content.quest.members.thetouristrap.TouristTrapPlugin.BedabinAnvilHandler.AnnaWinchHandler;
...
public final class TouristTrapPlugin extends OptionHandler {
        ...
        switch (option) {
            ...
            case "open":
                switch (id) {
                    ...
                    case 2690:
                    case 2691:
                        player.setAttribute("ana-delay", World.getTicks() + 2);
    ...
    public static final class AnnaCartHandler extends UseWithHandler {
        ...
        public boolean handle(final NodeUsageEvent event) {
            ...
            player.setAttribute("ana-delay", World.getTicks() + 100000000);
    ...
    public static final class MineCartDialogue extends DialoguePlugin {
        ...
        public static final class MiningCartCutscene extends CutscenePlugin {
            ...
            public void open() {
                ...
                World.getPulser().submit(new Pulse(22, player) {
                    @Override
                    public boolean pulse() {
        ...
        public boolean handle(int interfaceId, int buttonId) {
            switch (stage) {
                ...
                case 3:
                    ...
                    World.getPulser().submit(new Pulse(40) {
                        @Override
                        public boolean pulse() {
