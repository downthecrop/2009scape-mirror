...
public class ClientCommands {
    ...
    public static void ClientCommands(RSString command) {
        try {
            ...
            if (command.equalsStringIgnoreCase(TextCore.COMMAND_VARPDEBUG)){
                GameConfig.VARP_DEBUG = !GameConfig.VARP_DEBUG;
                BufferedDataStream.addChatMessage(null, 0, RSString.parse("Varp DEBUG turned " + (GameConfig.VARP_DEBUG ? "on" : "off")), -1);
            }
