...
final class ItemDefinition {
	...
	final void method1109(ItemDefinition var2, ItemDefinition var3) {
		try {
			...
			this.modelRotation2 = var3.modelRotation2;
			this.anInt803 = var2.anInt803;
			this.anInt796 = var2.anInt796;
			this.maleWieldX = var2.maleWieldX;
			this.modelRotation1 = var3.modelRotation1;
			this.anInt754 = var3.anInt754;
			this.anInt753 = var2.anInt753;
			this.femaleWieldX = var2.femaleWieldX;
			this.aShortArray772 = var2.aShortArray772;
			this.femaleWieldY = var2.femaleWieldY;
			this.femaleWieldZ = var2.femaleWieldZ;
	...
	final Model method1110(int var2, int var3, SequenceDefinition var4, int var5, int var6) {
		try {
			...
			if(var11 == null) {
				Model_Sub1 var12 = Model_Sub1.method2015(LinkableRSString.modelsIndex_2581, this.modelId);
				if(null == var12) {
					return null;
				}
	...
	private void parseOpcode(DataBuffer buffer, int opcode) {
		try {
			if(opcode == 1) {
				...
				this.maleEquip1 = buffer.readUnsignedShort();
			} else if (opcode == 24) {
				...
				if (opcode == 40) {
					...
					this.maleWieldX = buffer.readSignedByte();
					this.maleWieldY = buffer.readSignedByte();
					this.maleWieldZ = buffer.readSignedByte();
				} else if (opcode == 126) {
					this.femaleWieldX = buffer.readSignedByte();
					this.femaleWieldY = buffer.readSignedByte();
					this.femaleWieldZ = buffer.readSignedByte();
				} else if (opcode == 127) {
	...
	final Model_Sub1 method1117(boolean var1) {
		try {
			...
			if(var3 == -1) {
				...
				if(!var1 && (this.maleWieldX != 0 || this.maleWieldY != 0 || this.maleWieldZ != 0)) {
					Objects.requireNonNull(var6).method2001(this.maleWieldX, this.maleWieldY, this.maleWieldZ);
				}
				if(var1 && (this.femaleWieldX != 0 || this.femaleWieldY != 0 || this.femaleWieldZ != 0)) {
					Objects.requireNonNull(var6).method2001(this.femaleWieldX, this.femaleWieldY, this.femaleWieldZ);
				}
	...
	final void method1118(ItemDefinition var1, ItemDefinition var2) {
		try {
			...
			this.aShortArray774 = var2.aShortArray774;
			this.aShortArray772 = var2.aShortArray772;
			this.modelRotation1 = var2.modelRotation1;
			this.modelRotation2 = var2.modelRotation2;
			this.aShortArray751 = var2.aShortArray751;
			this.modelId = var2.modelId;
			this.aByteArray785 = var2.aByteArray785;
	...
	final Class140_Sub1_Sub2 method1120() {
		try {
			Model_Sub1 var2 = Model_Sub1.method2015(LinkableRSString.modelsIndex_2581, this.modelId);
			if(var2 == null) {
				return null;
			} else {
				int var3;
